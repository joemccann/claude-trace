      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group p-6 bg-zinc-900/50 border border-zinc-800 rounded-xl hover:border-zinc-700 hover:bg-zinc-900 transition-all duration-200"
            >
              <div className="w-12 h-12 rounded-lg bg-cyan-400/10 text-cyan-400 flex items-center justify-center mb-4 group-hover:bg-cyan-400/20 transition-colors">
                {feature.icon}
              </div>
