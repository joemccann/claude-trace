  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-colors duration-200 ${
        scrolled
          ? 'bg-bg-base/95 border-b border-border-faint'
          : 'bg-transparent'
      }`}
    >
      <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="font-medium text-text-primary tracking-tight">
            Claude Trace
          </span>
        </div>
        ...
        <a
          ...
          className="px-4 py-2 bg-accent text-bg-base text-sm font-medium hover:bg-accent-hover transition-colors flex items-center gap-2"
        >
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
